...
You could find RPM called **« wmic »** for (**WMI** **C**lient) at [https://rpmfind.net/linux/rpm2html/search.php?query=wmic&submit=Search](https://rpmfind.net/linux/rpm2html/search.php?query=wmic&submit=Search)
